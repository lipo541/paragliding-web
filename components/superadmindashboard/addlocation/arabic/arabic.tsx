...
export default function ArabicForm() {
  ...
  const flightTypes = arContent.flight_types || [];
  ...
  return (
    <div className="space-y-4">
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-foreground/60">
              ⚠️ არაბულად დაწერეთ ALT აღწერა ამ სურათისთვის
            </p>
          </div>
        </div>
      )}
      ...
      <div>
        <label className="block text-sm font-medium text-foreground mb-2">
          <span className={`${sharedVideos.videoUrls.length > 0 ? 'text-green-600 dark:text-green-400' : 'text-foreground/40'}`}>○</span> مقاطع فيديو YouTube
        </label>
        ...
        <div className="space-y-3">
            ...
            return (
              <div key={index} className="flex items-center gap-3 bg-foreground/5 p-3 rounded-lg border border-foreground/20">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-foreground/60 mb-1">فيديو #{index + 1}</p>
          ...
          <div className="border-2 border-dashed border-foreground/20 rounded-lg p-4 bg-foreground/5">
                ...
                onKeyPress={(e) => {
                  if (e.key === 'Enter' && newVideoUrl.trim()) {
                    ...
                    if (newVideoUrl.includes('youtube.com') || newVideoUrl.includes('youtu.be')) {
                      ...
                      alert('الرجاء لصق رابط فيديو YouTube');
                    }
                  }
                }}
            ...
            <p className="text-xs text-foreground/60 mt-2 flex items-center gap-1">
              ...
              الصق رابط فيديو YouTube الكامل واضغط على Enter أو انقر فوق زر الإضافة
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border border-foreground/20 rounded-lg focus:ring-2 focus:ring-foreground/20 focus:border-foreground/40 outline-none transition-all bg-background text-foreground"
          placeholder="مثال: الطيران الشراعي في جوداوري"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border border-foreground/20 rounded-lg focus:ring-2 focus:ring-foreground/20 focus:border-foreground/40 outline-none transition-all bg-background text-foreground"
          placeholder="مثال: تاريخ جوداوري"
        />
      </div>
      ...
      <div>
        ...
        <RichTextEditor
          ...
          placeholder="مثال: جوداوري هو واحد من أقدم وأشهر منتجعات التزلج في جورجيا..."
          minHeight="200px"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="مثال: صور من زوايا مختلفة للطيران ومناظر بانورامية..."
        />
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-foreground mb-2">
          <span className={`${arContent.h3_flight_types?.trim() ? 'text-green-600 dark:text-green-400' : 'text-foreground/40'}`}>○</span> H3 Tag (ფრენის ტიპები)
        </label>
        <input
          type="text"
          value={arContent.h3_flight_types || ""}
          onChange={(e) => updateLanguageContent('ar', { h3_flight_types: e.target.value })}
          className="w-full px-3 py-2 text-sm border border-foreground/20 rounded-lg focus:ring-2 focus:ring-foreground/20 focus:border-foreground/40 outline-none transition-all bg-background text-foreground"
          placeholder="مثال: أنواع الرحلات في جوداوري"
        />
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
        <p className="text-sm text-blue-800 dark:text-blue-200 flex items-start gap-2">
          ...
          <span><strong>ملاحظة:</strong> يجب إنشاء أنواع الرحلات الجديدة في النموذج الجورجي أولاً. هنا يمكنك فقط ترجمة أنواع الرحلات الموجودة.</span>
        </p>
      </div>
        ...
        return untranslated.length > 0 && (
          <div className="border-2 border-dashed border-orange-300 dark:border-orange-700 rounded-lg p-4 bg-orange-50/50 dark:bg-orange-900/10">
            <h4 className="text-sm font-semibold text-orange-800 dark:text-orange-300 mb-3 flex items-center gap-2">
              ...
              أنواع الرحلات التي تحتاج إلى ترجمة
            </h4>
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      onClick={() => {
                        ...
                        updateLanguageContent('ar', { ...arContent, flight_types: updatedFlightTypes });
                      }}
        ...
        <div className="border border-foreground/20 rounded-lg p-4 space-y-3 bg-foreground/5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="مثال: مثالي للمبتدئين..."
            />
          </div>
              ...
              {flightTypeFeatures.map((feature, index) => (
                <div key={index} className="flex items-center gap-2">
                  <input
                    ...
                    placeholder="مثال: مدة الطيران: 15-20 دقيقة"
                  />
                  <button
                    onClick={() => {
