...
import { Filter, LayoutGrid, List, SortAsc, ChevronDown, Check, MapPin } from 'lucide-react';
import { ViewMode, SortOption, Country, Location } from '../hooks/useCompaniesFilter';
...
export default function CompaniesFilters({
  ...
  const sortOptions: { value: SortOption; label: string }[] = [
    ...
    { value: 'date', label: translations.sortByDate },
    { value: 'rating', label: translations.sortByRating },
    { value: 'pilots', label: translations.sortByPilots },
  ];
