...
export default function PilotsSearch({
  value,
  onChange,
  placeholder,
  resultCount,
  ...
  return (
    <div className="relative mb-3">
      ...
      {/* Results count */}
      {value && (
        <div className="mt-1.5 text-xs text-[#2d2d2d]/60 dark:text-white/50">
          {resultText.replace('{count}', String(resultCount))}
        </div>
      )}
    </div>
  );
