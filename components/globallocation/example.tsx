...
export default function GlobalLocations({ locale }: GlobalLocationsProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="w-full backdrop-blur-xl bg-background/60 supports-[backdrop-filter]:bg-background/50 border-b border-foreground/20">
      ...
      {/* Filters & Controls */}
      <div className="w-full backdrop-blur-xl bg-background/60 supports-[backdrop-filter]:bg-background/50 border-b border-foreground/20 sticky top-16 z-40">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex items-center gap-2 w-full lg:w-auto">
              ...
              <div className="relative flex-1 lg:flex-initial">
                ...
                {isFilterOpen && (
                  <div className="absolute top-full left-0 right-0 lg:right-auto lg:w-64 mt-2 backdrop-blur-xl bg-background/60 supports-[backdrop-filter]:bg-background/50 border border-foreground/20 rounded-lg shadow-lg overflow-hidden z-50">
                    <button
                      onClick={() => {
                    ...
                    {locations.map(location => {
                      ...
                      return (
                        <Link
                          ...
                          className="group rounded-xl border backdrop-blur-md bg-white/20 dark:bg-black/20 border-white/30 dark:border-white/20 overflow-hidden hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-lg transition-all duration-300"
                        >
                          {/* Image */}
                    ...
                    {locations.map(location => {
                      ...
                      return (
                        <Link
                          key={location.id}
                          href={`/${locale}/locations/${countrySlug}/${locationSlug}`}
                          className="group flex items-center gap-4 p-4 rounded-lg border backdrop-blur-md bg-white/20 dark:bg-black/20 border-white/30 dark:border-white/20 hover:border-blue-500 dark:hover:border-blue-500 hover:bg-white/30 dark:hover:bg-black/30 transition-all duration-300"
                        >
                          {/* Thumbnail */}
