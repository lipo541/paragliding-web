    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-[#1a1a1a]/60 dark:text-white/60 animate-pulse">{t('hero.loading')}</p>
        </div>
      </div>
    );
  }
          ...
          <div className="text-center space-y-4 lg:space-y-6">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative" ref={heroSearchRef}>
                <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#1a1a1a]/60 dark:text-white/60 z-10" />
                <input
                  type="text"
                  ...
                  className="w-full pl-12 pr-12 py-4 text-base rounded-xl backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/20 focus:ring-2 focus:ring-[#4697D2]/50 focus:border-[#4697D2] outline-none transition-all text-[#1a1a1a] dark:text-white placeholder:text-[#1a1a1a]/50 dark:placeholder:text-white/50 shadow-xl"
                />
                {heroSearchQuery && (
                  <button
                    onClick={() => {
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-[#1a1a1a]/10 dark:hover:bg-white/10 transition-colors z-10"
                  >
                ...
                {isHeroSearchOpen && heroSearchResults.length > 0 && (() => {
                  const locationResults = heroSearchResults.filter(r => r.type === 'location');
                  const countryResults = heroSearchResults.filter(r => r.type === 'country');
                  ...
                  return (
                    <div className="absolute top-full left-0 right-0 mt-2 backdrop-blur-xl bg-white/95 dark:bg-black/95 border border-white/50 dark:border-white/20 rounded-xl shadow-2xl overflow-hidden z-[100] max-h-[500px] overflow-y-auto">
                      ...
                      {countryResults.length > 0 && (
                        <div>
                          {/* Section Header */}
                          <div className="sticky top-0 px-4 py-2 bg-[#4697D2]/20 dark:bg-[#4697D2]/30 backdrop-blur-md border-b border-[#4697D2]/30 z-10">
                            <div className="flex items-center gap-2">
                              <Globe className="w-4 h-4 text-[#4697D2]" />
                              <span className="text-sm font-bold text-[#1a1a1a] dark:text-white">{t('hero.countryBadge')}</span>
                              <span className="text-xs text-[#1a1a1a]/60 dark:text-white/60">({countryResults.length})</span>
                            </div>
                          </div>
                          ...
                          {countryResults.map((result) => {
                            ...
                            return (
                              <Link
                                ...
                                className="flex items-center gap-4 p-4 hover:bg-[#4697D2]/10 dark:hover:bg-white/10 transition-all border-b border-[#4697D2]/10 dark:border-white/5 last:border-0 group"
                                onMouseDown={(e) => {
                                  e.preventDefault();
                                  setHeroSearchQuery('');
                                  setIsHeroSearchOpen(false);
                              ...
                              >
                                {/* Country Icon */}
                                <div className="relative w-16 h-16 rounded-lg flex-shrink-0 bg-gradient-to-br from-[#4697D2]/20 to-[#4697D2]/10 flex items-center justify-center shadow-lg ring-2 ring-[#4697D2]/20 group-hover:ring-[#4697D2]/40 transition-all">
                                  <Globe className="w-8 h-8 text-[#4697D2]" />
                                </div>

                                {/* Country Info */}
                                <div className="flex-1 min-w-0">
                                  <p className="font-bold text-base text-[#1a1a1a] dark:text-white mb-1 truncate group-hover:text-[#4697D2] transition-colors">
                                    {getLocalizedName(country, 'name')}
                                  </p>
                                  <p className="text-sm text-[#1a1a1a]/70 dark:text-white/60">
                                ...
                                {country.cached_rating && (
                                  <div className="flex items-center gap-1 flex-shrink-0">
                                    ...
                                    <span className="text-sm font-bold text-[#1a1a1a] dark:text-white ml-1">
                        ...
                        <div>
                          ...
                          <div className="sticky top-0 px-4 py-2 bg-[#4697D2]/20 dark:bg-[#4697D2]/30 backdrop-blur-md border-b border-[#4697D2]/30 z-10">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm font-bold text-[#1a1a1a] dark:text-white">{t('hero.locationBadge')}</span>
                              <span className="text-xs text-[#1a1a1a]/60 dark:text-white/60">({locationResults.length})</span>
                            </div>
                          </div>
                          ...
                          {locationResults.map((result) => {
                            ...
                            return (
                              <Link
                                ...
                                className="block p-3 hover:bg-[#4697D2]/10 dark:hover:bg-white/10 transition-all border-b border-[#4697D2]/10 dark:border-white/5 last:border-0 group"
                                onMouseDown={(e) => {
                                  e.preventDefault();
                                  setHeroSearchQuery('');
                                  setIsHeroSearchOpen(false);
                              ...
                              >
                                <div className="flex gap-3">
                                  {/* Location Image */}
                                  <div className="relative w-24 h-24 rounded-lg overflow-hidden flex-shrink-0 shadow-md ring-1 ring-[#4697D2]/30 group-hover:ring-[#4697D2]/50 group-hover:shadow-lg transition-all">
                                    {location.og_image_url ? (
                                      ...
                                      <div className="w-full h-full bg-gradient-to-br from-[#4697D2]/10 to-[#4697D2]/20 flex items-center justify-center">
                                        <MapPin className="w-8 h-8 text-[#4697D2]/40" />
                                      </div>
                                    )}
                                  ...
                                  <div className="flex-1 min-w-0 flex flex-col">
                                    {/* Title & Country */}
                                    <div className="mb-2">
                                      <h3 className="font-bold text-base text-[#1a1a1a] dark:text-white mb-0.5 truncate group-hover:text-[#4697D2] transition-colors">
                                        {getLocalizedName(location, 'name')}
                                      </h3>
                                      <div className="flex items-center gap-1.5 text-xs text-[#1a1a1a]/70 dark:text-white/60">
                                        <Globe className="w-3 h-3 flex-shrink-0" />
                                        <span className="truncate">{country ? getLocalizedName(country, 'name') : ''}</span>
                                      </div>
                                    </div>
                                    
                                    {/* Flight Types with Prices */}
                                    {location.flight_types && location.flight_types.length > 0 && (
                                      <div className="flex-1 space-y-1">
                                        {location.flight_types.slice(0, 2).map((ft, ftIdx) => (
                                          <div key={ftIdx} className="flex items-start justify-between gap-3 py-1 px-2 rounded-md bg-[#4697D2]/10 dark:bg-white/5">
                                            <span className="text-xs font-medium text-[#1a1a1a] dark:text-white/80 truncate flex-1">
                                              {ft.name}
                                            </span>
                                            <span className="text-xs font-bold text-[#1a1a1a] dark:text-white whitespace-nowrap">
                                              {ft.price_gel ? `${ft.price_gel}₾` : ft.price_usd ? `$${ft.price_usd}` : ft.price_eur ? `€${ft.price_eur}` : ''}
                                            </span>
                                          </div>
                                        ))}
                                        {location.flight_types.length > 2 && (
                                          <p className="text-[10px] text-[#1a1a1a]/60 dark:text-white/50 italic text-center pt-0.5">
                ...
                {isHeroSearchOpen && heroSearchQuery && heroSearchResults.length === 0 && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-[rgba(70,151,210,0.95)] dark:bg-[#1a1a1a] border border-[#4697D2]/30 dark:border-white/20 rounded-xl shadow-2xl p-6 text-center z-[100]">
                    <p className="text-[#1a1a1a] dark:text-white/60">
            ...
            <div className="grid grid-cols-3 gap-2 lg:gap-4 max-w-3xl mx-auto">
              {/* Total Locations */}
              <div className="p-3 lg:p-6 rounded-xl backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 shadow-xl transition-all hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-1 lg:gap-3 mb-1 lg:mb-2">
                  <MapPin className="w-4 h-4 lg:w-6 lg:h-6 text-[#1a1a1a] dark:text-[#4697D2]" />
                  <p className="text-xl lg:text-3xl font-bold text-[#1a1a1a] dark:text-white">{totalLocations}</p>
                </div>
                <p className="text-[10px] lg:text-sm text-[#1a1a1a]/80 dark:text-white/80 font-medium">{t('stats.location')}</p>
              </div>

              {/* Total Countries */}
              <div className="p-3 lg:p-6 rounded-xl backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 shadow-xl transition-all hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-1 lg:gap-3 mb-1 lg:mb-2">
                  <Globe className="w-4 h-4 lg:w-6 lg:h-6 text-[#CAFA00]" />
                  <p className="text-xl lg:text-3xl font-bold text-[#1a1a1a] dark:text-white">{totalCountries}</p>
                </div>
                <p className="text-[10px] lg:text-sm text-[#1a1a1a]/80 dark:text-white/80 font-medium">{t('stats.country')}</p>
              </div>

              {/* Average Rating */}
              <div className="p-3 lg:p-6 rounded-xl backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 shadow-xl transition-all hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-1 lg:gap-3 mb-1 lg:mb-2">
                  <Star className="w-4 h-4 lg:w-6 lg:h-6 text-[#ffc107] fill-[#ffc107]" />
                  <p className="text-xl lg:text-3xl font-bold text-[#1a1a1a] dark:text-white">{avgRating > 0 ? avgRating.toFixed(1) : '—'}</p>
                </div>
                <p className="text-[10px] lg:text-sm text-[#1a1a1a]/80 dark:text-white/80 font-medium">{t('stats.rating')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-3 lg:px-4 py-2 lg:py-3 backdrop-blur-xl bg-[rgba(70,151,210,0.1)] dark:bg-black/80 rounded-b-xl">
          <div className="flex flex-col lg:flex-row gap-2 lg:gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex items-center gap-2 lg:gap-3 flex-wrap w-full lg:w-auto">
              ...
              <div className="relative flex-1 lg:flex-initial">
                <button
                  ...
                  className="flex items-center justify-between gap-2 px-3 lg:px-4 py-1.5 lg:py-2 text-xs lg:text-sm rounded-lg backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50 transition-all text-[#1a1a1a] dark:text-white shadow-lg w-full lg:w-auto"
                >
                ...
                {isFilterOpen && (
                  <div className="absolute top-full left-0 right-0 lg:right-auto mt-2 lg:w-64 bg-[rgba(70,151,210,0.95)] dark:bg-[#1a1a1a] border border-[#4697D2]/30 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden z-50 max-h-[60vh] overflow-y-auto">
                    <button
                      ...
                      className={`w-full px-4 py-3 text-sm text-left text-[#1a1a1a] dark:text-white hover:bg-white/20 dark:hover:bg-white/10 transition-all ${
                        selectedCountry === 'all' ? 'bg-white/20 dark:bg-white/10 font-semibold' : ''
                      }`}
                    >
                      {t('filters.allCountries')}
                    </button>
                    {countries.map((country) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-sm text-left text-[#1a1a1a] dark:text-white hover:bg-white/20 dark:hover:bg-white/10 transition-all ${
                          selectedCountry === country.id ? 'bg-white/20 dark:bg-white/10 font-semibold' : ''
                        }`}
                      >
                        {getLocalizedName(country, 'name')}
                      </button>
              ...
              <div className="relative flex-1 lg:flex-initial lg:min-w-[280px]">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 lg:w-4 lg:h-4 text-[#1a1a1a]/60 dark:text-white/60" />
                <input
                  type="text"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder={t('filters.searchPlaceholder')}
                  className="w-full pl-9 lg:pl-10 pr-9 lg:pr-10 py-1.5 lg:py-2 text-xs lg:text-sm rounded-lg backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 focus:ring-2 focus:ring-[#4697D2]/50 focus:border-[#4697D2] outline-none transition-all text-[#1a1a1a] dark:text-white placeholder:text-[#1a1a1a]/50 dark:placeholder:text-white/50 shadow-lg"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery('')}
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-0.5 rounded-full hover:bg-[#1a1a1a]/10 dark:hover:bg-white/10 transition-colors"
                  >
                    <X className="w-3 h-3 lg:w-3.5 lg:h-3.5 text-[#1a1a1a]/60 dark:text-white/60" />
                  </button>
                )}
              </div>
                ...
                {isSortOpen && (
                  <div className="absolute top-full left-0 right-0 lg:right-auto mt-2 lg:w-48 bg-[rgba(70,151,210,0.95)] dark:bg-[#1a1a1a] border border-[#4697D2]/30 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden z-50">
                    <button
                      ...
                      className={`w-full px-4 py-3 text-sm text-left text-[#1a1a1a] dark:text-white hover:bg-white/20 dark:hover:bg-white/10 transition-all ${
                        sortBy === 'rating' ? 'bg-white/20 dark:bg-white/10 font-semibold' : ''
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 text-sm text-left text-[#1a1a1a] dark:text-white hover:bg-white/20 dark:hover:bg-white/10 transition-all ${
                        sortBy === 'name' ? 'bg-white/20 dark:bg-white/10 font-semibold' : ''
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 text-sm text-left text-[#1a1a1a] dark:text-white hover:bg-white/20 dark:hover:bg-white/10 transition-all ${
                        sortBy === 'altitude' ? 'bg-white/20 dark:bg-white/10 font-semibold' : ''
                      }`}
                    >
            ...
            <div className="flex items-center justify-between gap-2 lg:gap-3 w-full lg:w-auto">
              ...
              <p className="text-[10px] lg:text-xs text-[#1a1a1a]/70 dark:text-white/70 order-1 lg:order-2">
                {t('filters.resultsFound')} <span className="font-semibold text-[#1a1a1a] dark:text-white">{sortedLocations.length}</span>
              </p>
              
              {/* View Mode Toggle */}
              <div className="flex items-center gap-0.5 lg:gap-1 backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 rounded-lg p-0.5 lg:p-1 shadow-lg order-2 lg:order-1">
                <button
                  onClick={() => setViewMode('grid')}
                  className={`p-1.5 lg:p-2 rounded transition-all ${
                    viewMode === 'grid' 
                      ? 'bg-[#4697D2]/30 dark:bg-black/90 text-[#1a1a1a] dark:text-white shadow-md' 
          ...
          {hasActiveFilters && (
            <div className="flex items-center gap-1.5 lg:gap-2 mt-2 lg:mt-3 flex-wrap">
              <span className="text-[10px] lg:text-xs text-[#1a1a1a]/70 dark:text-white/70">{t('filters.activeFilters')}</span>
              
              {selectedCountry !== 'all' && (
                <span className="flex items-center gap-1 lg:gap-1.5 px-2 lg:px-3 py-0.5 lg:py-1 text-[10px] lg:text-xs rounded-full backdrop-blur-md bg-[#1a1a1a]/10 dark:bg-[#4697D2]/20 border border-[#1a1a1a]/30 dark:border-[#4697D2]/30 text-[#1a1a1a] dark:text-[#4697D2]">
                  <span className="truncate max-w-[120px]">{getLocalizedName(countries.find(c => c.id === selectedCountry), 'name')}</span>
                  <button
                    onClick={() => setSelectedCountry('all')}
                    className="hover:bg-[#1a1a1a]/20 dark:hover:bg-[#4697D2]/30 rounded-full p-0.5 transition-colors flex-shrink-0"
                  >
              ...
              {searchQuery && (
                <span className="flex items-center gap-1 lg:gap-1.5 px-2 lg:px-3 py-0.5 lg:py-1 text-[10px] lg:text-xs rounded-full backdrop-blur-lg bg-blue-500/10 border border-blue-500/30 text-blue-600 dark:text-blue-400">
                  ...
                  <button
                    onClick={clearSearch}
                    className="hover:bg-[#4697D2]/30 rounded-full p-0.5 transition-colors flex-shrink-0"
                  >
                    <X className="w-2.5 h-2.5 lg:w-3 lg:h-3" />
                  </button>
                </span>
      ...
      <div ref={contentRef} className="max-w-[1280px] mx-auto px-4 py-8 lg:py-12">
        {groupedLocations.length === 0 ? (
          ...
          <div className="text-center py-16 lg:py-24">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 mb-6 shadow-xl">
              <MapPin className="w-10 h-10 text-[#1a1a1a]/60 dark:text-white/40" />
            </div>
            <h3 className="text-xl font-bold text-[#1a1a1a] dark:text-white mb-2">{t('empty.title')}</h3>
            <p className="text-[#1a1a1a]/70 dark:text-white/70 mb-6">{t('empty.description')}</p>
            <button
              onClick={clearFilters}
              className="px-6 py-3 rounded-lg backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50 transition-all text-[#1a1a1a] dark:text-white font-medium shadow-xl"
            >
              {t('empty.viewAll')}
            </button>
          </div>
            ...
            {groupedLocations.map(({ country, locations: countryLocations }) => {
              ...
              return (
                <div key={country.id} className="space-y-6">
                  ...
                  <div className="rounded-xl backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 shadow-xl p-3 lg:p-6">
                    <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
                      {/* Top Row: Collapse Button + Country Info */}
                      <div className="flex items-center gap-2 lg:gap-4 flex-1">
                        <button
                          onClick={() => toggleCountry(country.id)}
                          className="p-1.5 lg:p-2 rounded-lg hover:bg-[#4697D2]/20 dark:hover:bg-white/10 transition-all flex-shrink-0"
                        >
                          {isCollapsed ? (
                            <ChevronDown className="w-4 h-4 lg:w-5 lg:h-5 text-[#1a1a1a] dark:text-white" />
                          ) : (
                            <ChevronUp className="w-4 h-4 lg:w-5 lg:h-5 text-[#1a1a1a] dark:text-white" />
                          )}
                        </button>
                        
                        <div className="flex-1 min-w-0">
                          <h2 className="text-base lg:text-2xl font-bold text-[#1a1a1a] dark:text-white mb-1 truncate">
                            {getLocalizedName(country, 'name')}
                          </h2>
                          
                          <div className="flex items-center gap-2 lg:gap-3 flex-wrap">
                            <span className="text-xs lg:text-sm text-[#1a1a1a]/70 dark:text-white/70 whitespace-nowrap">
                            ...
                            {country.cached_rating && country.cached_rating > 0 && (
                              <div className="flex items-center gap-0.5 lg:gap-1">
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <Star
                                    ...
                                    className={`w-3 h-3 lg:w-3.5 lg:h-3.5 ${
                                      star <= Math.round(country.cached_rating!)
                                        ? 'text-[#ffc107] fill-[#ffc107]'
                                        : 'text-[#ffc107]/30 fill-transparent'
                                    }`}
                                  />
                                ))}
                                ...
                                <span className="text-[9px] lg:text-[10px] text-[#1a1a1a]/60 dark:text-white/60">
                      ...
                      <Link
                        ...
                        className="px-3 py-1.5 lg:px-4 lg:py-2 text-xs lg:text-sm rounded-lg backdrop-blur-md bg-[rgba(70,151,210,0.2)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 hover:bg-[rgba(70,151,210,0.3)] dark:hover:bg-black/50 transition-all text-[#1a1a1a] dark:text-white font-medium shadow-lg text-center lg:whitespace-nowrap"
                      >
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-4">
                        {countryLocations.map((location, index) => {
                          ...
                          return (
                            <div
                              key={location.id}
                              className="group rounded-xl overflow-hidden backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50 hover:shadow-2xl transition-all duration-300 shadow-xl relative"
                              style={{
                              ...
                              <div className="relative aspect-video overflow-hidden bg-[#4697D2]/5 dark:bg-white/5">
                                {location.hero_image_url ? (
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    <MapPin className="w-12 h-12 text-[#1a1a1a]/30 dark:text-white/20" />
                                  </div>
                                )}
                                      ...
                                      <Star
                                        ...
                                        className={`w-3 h-3 lg:w-3.5 lg:h-3.5 ${
                                          star <= Math.round(location.cached_rating!)
                                            ? 'text-[#ffc107] fill-[#ffc107]'
                                            : 'text-[#1a1a1a]/20 dark:text-white/20 fill-[#1a1a1a]/20 dark:fill-white/20'
                                        }`}
                                      />
                                    ))}
                                    <span className="text-[11px] lg:text-xs font-semibold text-[#1a1a1a] dark:text-white ml-1">
                                ...
                                <div className="space-y-1 lg:space-y-1.5">
                                  {location.altitude && (
                                    <div className="flex items-center gap-1 lg:gap-1.5 text-[11px] lg:text-xs text-[#2d2d2d] dark:text-white/70">
                                      <svg className="w-3 h-3 lg:w-3.5 lg:h-3.5 text-[#1a1a1a] dark:text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="space-y-2">
                        {countryLocations.map((location, index) => {
                          ...
                          return (
                            <div
                              key={location.id}
                              className="group flex items-center gap-3 lg:gap-4 p-2 lg:p-3 rounded-lg lg:rounded-xl backdrop-blur-md bg-[rgba(70,151,210,0.15)] dark:bg-black/40 border border-[#4697D2]/30 dark:border-white/10 hover:bg-[rgba(70,151,210,0.25)] dark:hover:bg-black/50 hover:shadow-xl transition-all duration-300 shadow-lg relative"
                              style={{
                                animation: `fadeInUp 0.5s ease-out ${index * 0.03}s both`
                              }}
                            >
                              {/* Thumbnail */}
                              <div className="relative w-16 h-16 lg:w-20 lg:h-20 rounded-md lg:rounded-lg overflow-hidden bg-[#1a1a1a]/5 dark:bg-white/5 flex-shrink-0">
                                {location.hero_image_url ? (
                                  <Image
                                    src={location.hero_image_url}
                                    alt={getLocalizedName(location, 'name')}
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    <MapPin className="w-6 h-6 lg:w-8 lg:h-8 text-[#1a1a1a]/30 dark:text-white/20" />
                                  </div>
                                )}
                              </div>
                              ...
                              {/* Info */}
                              <div className="flex-1 min-w-0">
                                <h3 className="text-sm lg:text-base font-bold text-[#1a1a1a] dark:text-white group-hover:text-[#4697D2] dark:group-hover:text-[#4697D2] transition-colors mb-1 truncate">
                                  {getLocalizedName(location, 'name')}
                                </h3>
                                ...
                                {location.cached_rating && location.cached_rating > 0 && (
                                  <div className="flex items-center gap-0.5 lg:gap-1 mb-1.5 lg:mb-2">
                                    ...
                                    <span className="text-[11px] lg:text-xs font-semibold text-[#1a1a1a] dark:text-white ml-0.5 lg:ml-1">
                                      {location.cached_rating.toFixed(1)}
                                    </span>
                                    <span className="text-[9px] lg:text-[10px] text-[#1a1a1a]/60 dark:text-white/60">
                                      ({location.cached_rating_count})
                                ...
                                {/* Details */}
                                <div className="flex items-center gap-2 lg:gap-3 flex-wrap text-[10px] lg:text-xs text-[#2d2d2d] dark:text-white/70">
                                  {location.altitude && (
                                    <span className="flex items-center gap-0.5 lg:gap-1">
                                      <svg className="w-2.5 h-2.5 lg:w-3 lg:h-3 text-[#1a1a1a] dark:text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7m0 0l7 7m-7-7v18" />
                                      </svg>
                                      {location.altitude}მ
                                    </span>
                              ...
                              <button
                                ...
                                className="px-3 lg:px-4 py-1.5 lg:py-2 text-xs lg:text-sm font-semibold rounded-md lg:rounded-lg bg-gradient-to-r from-[#2196f3] to-[#1976d2] hover:from-[#1976d2] hover:to-[#1565c0] text-white shadow-md hover:shadow-lg transition-all duration-300 flex-shrink-0 z-10 relative"
                              >
                                {t('location.book')}
                              </button>
