...
export default function Header() {
  ...
  return (
    <>
      <header 
        className="sticky top-0 z-[100] w-full backdrop-blur-xl bg-background/80 border-b border-foreground/20 shadow-lg"
      ...
      {activeMenu && (
        <div
          className="fixed left-0 right-0 top-[57px] backdrop-blur-xl bg-background/90 border-b border-foreground/30 shadow-2xl z-[110] animate-in fade-in slide-in-from-top-2 duration-200"
