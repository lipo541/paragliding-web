...
interface PilotCoverImageUploadProps {
  pilotId: string;
  userId: string;
...
export default function PilotCoverImageUpload({
  pilotId,
  userId,
  coverImageUrl,
  onUpdate,
}: PilotCoverImageUploadProps) {
    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="text-xs text-[#1a1a1a]/50 dark:text-white/50">
          ეს სურათი გამოჩნდება თქვენი პროფილის ზედა ნაწილში (რეკომენდებული: 1920x600px)
        </p>
      </div>
